...
locationsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, city, uf, items, parsedItems, locations, locations;
...
locationsRouter.post("/", celebrate_1.celebrate({
    body: celebrate_1.Joi.object().keys({
        ...
        items: celebrate_1.Joi.array().items(celebrate_1.Joi.number()),
    }),
}, {
    abortEarly: false,
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                locationItems = items.map(function (item_id) { return __awaiter(void 0, void 0, void 0, function () {
                    var selectedItem;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, transaction("items").where("id", item_id).first()];
                            case 1:
                                selectedItem = _a.sent();
                                if (!selectedItem) {
                                    return [2 /*return*/, response.status(400).json({ message: "Item not found." })];
                                }
                                return [2 /*return*/, {
                                        item_id: item_id,
...
locationsRouter.put('/:id', upload.single('image'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, image, location, locationUpdated;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
            ...
            case 1:
                ...
                locationUpdated = __assign(__assign({}, location), { image: image });
                return [4 /*yield*/, connection_1.default('locations').update(locationUpdated).where('id', id)];
            case 2:
                _a.sent();
                return [2 /*return*/, response.json(locationUpdated)];
        }
    });
}); });
